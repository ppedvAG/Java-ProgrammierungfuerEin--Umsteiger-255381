...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String wiederholen = "";
        do {
            //Aufruf der Methode GetInput zum Einlesen von 2 Zahlen
            ...
            //Aufruf der Methode GetRechenoperation
            Rechenoperation operation = GetRechenoperation();
            //Aufruf der Methode Berechne
            double ergebnis = Berechne(zahl1, zahl2, operation);
            //Aufruf von ConvertRechenoperation
    ...
    static double Berechne(double x, double y, Rechenoperation rechenoperation)
    {
    ...
    static String ConvertRechenoperation(Rechenoperation rechenoperation)
    {
